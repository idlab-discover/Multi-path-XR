...
if [[ "$RELEASE_MODE" == "true" ]]; then
    EXECUTABLE="../../target/x86_64-unknown-linux-gnu/release/metrics"
else
    EXECUTABLE="../../target/x86_64-unknown-linux-gnu/debug/metrics"
fi
...
echo "The metrics program has stopped."
