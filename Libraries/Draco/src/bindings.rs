...
pub type ostream = __BindgenOpaqueArray<u64, 34usize>;
...
pub struct DataBuffer {
    pub data_: __BindgenOpaqueArray<u64, 3usize>,
...
pub struct Options {
    ...
    pub options_: __BindgenOpaqueArray<u64, 6usize>,
}
unsafe extern "C" {
...
pub struct EncoderBuffer {
    ...
    pub buffer_: __BindgenOpaqueArray<u64, 3usize>,
...
unsafe extern "C" {
    ...
    pub fn EncoderBuffer_buffer(this: *mut EncoderBuffer)
    -> *mut __BindgenOpaqueArray<u64, 3usize>;
}
unsafe extern "C" {
...
impl EncoderBuffer {
    ...
    #[inline]
    pub unsafe fn buffer(&mut self) -> *mut __BindgenOpaqueArray<u64, 3usize> {
...
#[doc = " D-dimensional vector class with basic operations."]
pub type Vector3f = __BindgenOpaqueArray<u32, 3usize>;
...
unsafe extern "C" {
    ...
    pub fn EntryValue_data(this: *const EntryValue) -> *const __BindgenOpaqueArray<u64, 3usize>;
}
unsafe extern "C" {
...
impl EntryValue {
    #[inline]
    pub unsafe fn data(&self) -> *const __BindgenOpaqueArray<u64, 3usize> {
...
#[derive(Debug, Default)]
pub struct Metadata {
    pub entries_: __BindgenOpaqueArray<u64, 6usize>,
    pub sub_metadatas_: __BindgenOpaqueArray<u64, 6usize>,
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn Metadata_GetEntryIntArray(
        this: *const Metadata,
        name: *const string,
        value: *mut __BindgenOpaqueArray<u64, 3usize>,
    ) -> bool;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn Metadata_entries(this: *const Metadata) -> *const __BindgenOpaqueArray<u64, 6usize>;
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNK5draco8Metadata13sub_metadatasB5cxx11Ev"]
    pub fn Metadata_sub_metadatas(
        this: *const Metadata,
    ) -> *const __BindgenOpaqueArray<u64, 6usize>;
}
unsafe extern "C" {
...
impl Metadata {
    ...
    #[inline]
    pub unsafe fn AddEntryIntArray(
        &mut self,
        name: *const string,
        value: *const __BindgenOpaqueArray<u64, 3usize>,
    ) {
    ...
    #[inline]
    pub unsafe fn GetEntryIntArray(
        &self,
        name: *const string,
        value: *mut __BindgenOpaqueArray<u64, 3usize>,
    ) -> bool {
    ...
    #[inline]
    pub unsafe fn entries(&self) -> *const __BindgenOpaqueArray<u64, 6usize> {
        Metadata_entries(self)
    }
    #[inline]
    pub unsafe fn sub_metadatas(&self) -> *const __BindgenOpaqueArray<u64, 6usize> {
...
pub struct GeometryMetadata {
    pub _base: Metadata,
    pub att_metadatas_: __BindgenOpaqueArray<u64, 3usize>,
}
unsafe extern "C" {
...
impl GeometryMetadata {
    ...
    #[inline]
    pub unsafe fn attribute_metadatas(&self) -> *const __BindgenOpaqueArray<u64, 3usize> {
...
pub struct PointCloud {
    ...
    pub attributes_: __BindgenOpaqueArray<u64, 3usize>,
    #[doc = " Ids of named attributes of the given type."]
    pub named_attribute_index_: __BindgenOpaqueArray<u64, 15usize>,
...
pub struct Mesh {
    ...
    pub attribute_data_: __BindgenOpaqueArray<u64, 3usize>,
...
pub type Mesh_Face = __BindgenOpaqueArray<u32, 3usize>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct AttributesEncoder {
    ...
    pub point_attribute_ids_: __BindgenOpaqueArray<u64, 3usize>,
    #[doc = " Map between point attribute id and the local id (i.e., the inverse of the\n |point_attribute_ids_|."]
    pub point_attribute_to_local_id_map_: __BindgenOpaqueArray<u64, 3usize>,
...
unsafe extern "C" {
    ...
    pub fn AttributesEncoder_SetAttributeIds(
        ...
        point_attribute_ids: *const __BindgenOpaqueArray<u64, 3usize>,
    );
}
unsafe extern "C" {
...
pub struct PointCloudEncoder {
    ...
    pub point_cloud_: *const PointCloud,
    pub attributes_encoders_: __BindgenOpaqueArray<u64, 3usize>,
    #[doc = " Map between attribute id and encoder id."]
    pub attribute_to_encoder_map_: __BindgenOpaqueArray<u64, 3usize>,
    ...
    pub attributes_encoder_ids_order_: __BindgenOpaqueArray<u64, 3usize>,
...
pub struct PointCloudDecoder {
    ...
    pub attributes_decoders_: __BindgenOpaqueArray<u64, 3usize>,
    #[doc = " Map between attribute id and decoder id."]
    pub attribute_to_decoder_map_: __BindgenOpaqueArray<u64, 3usize>,
